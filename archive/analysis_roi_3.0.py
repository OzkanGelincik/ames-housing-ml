...
# ==========================================
# 4. SELECT A BASE HOUSE (SCENARIO B: LUXURY NEIGHBORHOOD)
# ==========================================
# Let's move the house to "Northridge Heights" (High demand)
base_house = pd.DataFrame([model_defaults])

# Set baseline features for a "Good" house in a "Great" neighborhood
base_house['Neighborhood'] = 'NridgHt'  # <--- The Magic Switch
base_house['OverallQual'] = 7           # Good Quality (Standard for NridgHt)
base_house['GrLivArea'] = 1800          # Decent size

# Reset the features we want to test (Simulate a house MISSING these items)
base_house['KitchenQual'] = 'TA'        # Bad Kitchen for this area
base_house['GarageCars'] = 0            # MISSING Garage (Huge penalty in NridgHt)
base_house['CentralAir'] = 'N'          # MISSING AC (Huge penalty)
