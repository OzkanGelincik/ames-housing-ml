...
renovations = {
    "Luxury Kitchen Upgrade": {
        ...
        "cost": 25000 # <-- (DIY/Wholesale: Investor Pricing)
    },
    "Add Garage (2-Car)": {
        "changes": {
            "GarageCars": 2,
        ...
        "cost": 20000 # <-- (DIY/Wholesale: Investor Pricing)
    },
    ...
    "Install Central Air": {
        ...
        "cost": 6000 # <-- (DIY/Wholesale: Investor Pricing)
    },
    "Add Fireplace": {
        "changes": {
            "Fireplaces": 1,
        ...
        "cost": 2500 # <-- (DIY/Wholesale: Investor Pricing)
    }
}

# ==========================================
# 4. SELECT A BASE HOUSE (SCENARIO C: CLEAN & REALISTIC)
# ==========================================
# Start with defaults
base_house = pd.DataFrame([model_defaults])

# --- A. LOCATION & AGE (The Context) ---
# Northridge Heights is a modern luxury area
base_house['Neighborhood'] = 'NridgHt'
base_house['YearBuilt'] = 2005
base_house['YearRemodAdd'] = 2005
base_house['OverallQual'] = 8  # "Very Good" (Standard for this area)
base_house['GrLivArea'] = 2000 # Larger size

# --- B. REMOVE THE AMENITIES (Create the "Deficiency") ---
# 1. STRIP THE GARAGE COMPLETELY
base_house['GarageCars'] = 0
base_house['GarageArea'] = 0       # <--- CRITICAL: Must match Cars
base_house['GarageType'] = "None"  # <--- CRITICAL: Remove "Attached"
base_house['GarageFinish'] = "None"
base_house['GarageYrBlt'] = 0      # Or a placeholder for "No Garage"

# 2. STRIP THE BASEMENT
base_house['BsmtFinSF1'] = 0
base_house['TotalBsmtSF'] = 1000   # Unfinished basement exists
base_house['BsmtQual'] = "Gd"      # Good height/structure, just unfinished

# 3. STRIP THE EXTRAS
base_house['KitchenQual'] = 'TA'   # "Builder Grade" kitchen
